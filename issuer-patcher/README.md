...
> **Note**: The authoritative source is [hytale-auth-server/patcher](https://github.com/sanasol/hytale-auth-server/tree/main/patcher).
> This Docker image downloads the patcher from there at build time.
...
Already integrated. Set `HYTALE_DUAL_AUTH=true` (default).

### For hytale-f2p Launcher

Download the patcher at runtime:

```javascript
const PATCHER_URL = 'https://raw.githubusercontent.com/sanasol/hytale-server-docker/main/issuer-patcher/DualAuthPatcher.java';
```

### For Custom Integration

1. Download `DualAuthPatcher.java`
